...
$(function() {
  ...
  $('.movie-button').on('click',function(){
    // api will be called and details will be loaded just when we click the movie button or the button just below the search panel
    ...
    $('.home-button').on('click',function(){
      // trying to show the homw page again with the initial recommended part
...
// all the details will be posted to the recommend.html
  $.ajax({
    type:'POST',
    data:details,
    url:"/recommend",

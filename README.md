...
2. Install all the libraries mentioned in the [requirements.txt]((https://github.com/Amruta-Pawar2001/Movie-Recom-System/blob/main/requirements.txt)) file with the command `pip install -r requirements.txt`
